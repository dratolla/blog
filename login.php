...
<body class="general">
    ...
    <div class="container-fluid" id="container-fluid">
        <div class="text-center">
            <form action="" method="post" id="form-login" class="bg-white border rounded">
                <div class="mt-2">
                    <a href="https://albashiroh.com" class="btn btn-outline-dark">Ke Webpage Utama</a>
                </div>
                <h1 class="h3 mt-3 mb-3 font-weight-normal text-dark fs-1 font-monospace">Halaman Login</h1>
    
                <img src="img/logoRQS.png" alt="Logo Albashiroh" class="w-50 mb-5">
                ...
                <?php endif; ?>
                        ...
                        <input type="text" name="username" id="username" class="form-control" placeholder="Username" autofocus autocomplete="off" required>
                    ...
                    <p class="mt-3 ">&copy;Copyright by Adam Fitriyan<p>
